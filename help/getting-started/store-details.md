...
1. Håll pekaren över behållaren i HTML för att visa verktygslådan och välj ikonen _Inställningar_ ( ![Inställningar-ikon](../page-builder/assets/pb-icon-settings.png) ).
