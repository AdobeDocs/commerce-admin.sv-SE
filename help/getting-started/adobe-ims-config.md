...
>[!IMPORTANT]
>
>Integreringen med AdobeIms tillämpas globalt. När den är aktiverad måste alla användare autentisera via AdobeIms. Det går inte att utesluta enskilda användare från den här konfigurationen, och inloggning med användarnamn och lösenord är inte längre tillgänglig för enskilda användare.
>
...
* Ett Adobe.com med åtkomst till [Adobe Admin Console](https://adminconsole.adobe.com/).
  ...
  >[!NOTE]
  >
  >Om du inte har tillgång till Adobe Commerce Admin Console skickar du en begäran till ditt kontoteam om att ge åtkomst.
