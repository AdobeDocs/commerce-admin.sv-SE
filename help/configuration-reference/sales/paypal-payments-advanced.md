...
description: Granska konfigurationsinställningarna i avsnittet [!UICONTROL PayPal Payments Advanced] på sidan [!UICONTROL Sales] &gt; [!UICONTROL Payment Methods] i Commerce Admin.
...
![Grundinställningar för PayPal Express-utcheckning](./assets/payment-methods-paypal-advanced-express-checkout-basic-settings.png)<!-- zoom -->
...
![Avancerade inställningar för PayPal Express-utcheckning](./assets/payment-methods-paypal-payments-advanced-express-checkout-advanced.png)<!-- zoom -->
