...
| [!UICONTROL API Authentication Methods] | Webbplats | Bestämmer vilken metod som används för API-autentisering. Alternativ: <br/>**`API Signature`**- Visar fältet _[!UICONTROL API Signature]_i formuläret.<br/>**`API Certificate`**- Visar fältet_[!UICONTROL API Certificate]_ i formuläret. |
