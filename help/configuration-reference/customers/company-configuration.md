...
![Kundrelaterade mejl](./assets/company-email-options-customer-related-emails.png)<!-- zoom -->
...
![Ändra företagsstatus](./assets/company-email-options-company-status-change.png)<!-- zoom -->
