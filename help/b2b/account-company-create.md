...
1. När du skapar det första företaget är stödrastret _[!UICONTROL Company Hierarchy]_&#x200B;tomt när du expanderar det. När du har sparat företaget kan du inkludera det i en företagshierarki. Se [Företagshantering](manage-companies.md).
