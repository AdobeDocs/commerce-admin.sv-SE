...
Dessa funktioner och tillägg utvecklades som en del av [lagerprojektet](https://github.com/magento/inventory) via Magento Open Source Community Engineering-programmet.
