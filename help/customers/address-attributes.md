...
| [!UICONTROL Grid Filter Condition Type] | Anger filtermatchningsvillkor för attribut i sökåtgärder från rutnätet. Det påverkar inte fältet _[!UICONTROL Search by keyword]_&#x200B;för stödrastret. Alternativ: `Partial Match` / `Prefix Match` / `Full Match` |
