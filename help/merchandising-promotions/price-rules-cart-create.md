...
>[!NOTE]
>
>Kundprisregeln tillämpas på **_varje_** produkt i kundvagnen när uppsättningen villkor på fliken _[!UICONTROL Conditions]_uppfylls. Lägg till villkor på fliken_[!UICONTROL Actions]_ för att begränsa antalet produkter som påverkas av kundprisregeln.
