...
>[!NOTE]
> Adobe Commerce handlare som använder Live Search, Catalog Service eller Product Recommendations har möjlighet att använda en [SaaS-baserad prisindexerare](https://experienceleague.adobe.com/sv/docs/commerce/price-indexer/price-indexing).
